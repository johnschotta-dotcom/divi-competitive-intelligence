...
export const DIVI_BASELINE = {
  ...
  positioning_vs_market:
    'Divi is the gold standard reference in this dashboard: AI-assisted angel operations, not a pure deal marketplace, not a full institutional LP portal, and not spreadsheet-only tracking.',
