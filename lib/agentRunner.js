...
function diviReferenceFromPresence(diviPresence) {
  return ensureComparisonShape({
    ...
    sentiment_score: 80,
    sentiment_summary:
      'Divi reference tone: strong baseline product narrative (AI angel OS, portfolio, syndicate, education). Live divi.fund HTML is a JS shell, so messaging strength is anchored to the product baseline plus any crawlable meta.',
    positive_themes: 'AI-native · Portfolio tracking · Syndicate tools · Investor education',
    negative_themes: 'Public site copy is thin vs product depth — keep marketing pages sharper than specialists',
    media: [],
