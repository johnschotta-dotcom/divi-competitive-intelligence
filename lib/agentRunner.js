...
Compare the competitor's website/LinkedIn evidence against Divi's authoritative product baseline.
...
Do not invent funding or press for the competitor. Use competitor title/meta/body/nav/LinkedIn that appear below.
...
Scores for market_overlap_score / true_competitor_label:
- 80-100 direct: same primary buyer job as Divi — especially angel/individual-investor portfolio tracking, monitoring, and reporting. If that is their core product, score direct even when they lack AI, syndicates, or education. Missing pillars means Divi wins those matrix rows; it does NOT push them down to adjacent.
- 50-79 adjacent: investor software with a different primary job (GP fund admin, LP portals, CRM-only, banking, back-office).
- 20-49 tangential: shared audience only (deal marketplaces, content, communities) without portfolio-ops as the core offer.
- 0-19 not_a_competitor: clearly outside angel/portfolio operating software.
  ...
  return ensureComparisonShape({
    ...
    weaknesses: [
      {
        ...
        divi_advantage:
          'Own the intelligence-layer / Investment Health Score™ story on divi.fund + LinkedIn',
      },
    ],
    sentiment_score: 85,
    sentiment_summary:
    ...
    comparison: {
      ...
      strategic_recommendation:
        'Keep divi.fund + LinkedIn aligned with lib/diviBaseline.js (one-pager overview, ICP, vision, Investment Health Score™).',
      feature_matrix: [],
    },
