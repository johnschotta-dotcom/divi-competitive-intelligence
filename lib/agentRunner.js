...
- 0-19 → true_competitor_label MUST be "not_a_competitor": clearly outside angel/portfolio operating software.
Never return a label that conflicts with the score band (e.g. 45 cannot be adjacent).
