...
const styles = {
  ...
  profileHeader: { background: '#1a1a1a', border: '1px solid #2d2d2d', borderRadius: '12px', padding: '40px', marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'start' },
  profileLeft: {},
  profileRight: { textAlign: 'right' },
  breadcrumb: { fontSize: '0.9em', opacity: 0.6, textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: '600', marginBottom:
